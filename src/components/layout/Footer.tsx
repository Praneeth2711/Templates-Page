export function Footer() {
  return (
    <footer className="bg-[#F8FAFC] border-t border-border pt-20 pb-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-16">
          <div className="col-span-2">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
              The AI-native platform for building enterprise applications, internal tools, and scalable systems in seconds.
            </p>
          </div>
